...
function selectAccountTab(tab) {
  ...
  document.querySelector("#verification-state").hidden = true;
  showAccountMessage("");
...
document.querySelector("#register-form").addEventListener("submit", async (event) => {
  ...
  try {
    ...
    document.querySelector("#verification-email").textContent = String(form.get("email"));
    document.querySelector("#verification-state").hidden = false;
    showAccountMessage("");
